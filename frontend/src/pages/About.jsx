      ...
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] gap-7 flex flex-col min-h-screen py-4 justify-center">
        <div>
          ...
          <p className="text-xl text-stone-600">
            Welcome to Jualan<span className="text-[#D6482b]">Online</span>, the
            ultimate destination for online auctions and bidding excitement.
            Founded in 2024, we are dedicated to providing a dynamic and
            user-friendly platform for buyers and sellers to connect, explore,
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            At Jualan<span className="text-[#D6482b]">Online</span>, our mission
            is to revolutionize the way people buy and sell items online. We
            strive to create an engaging and trustworthy marketplace that
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            Founded by Mkaidev, Jualan
            <span className="text-[#D6482b]">Online</span> was born out of a
            passion for connecting people with unique and valuable items. With
            years of experience in the auction industry, our team is committed
            to creating a platform that offers an unparalleled auction
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            Whether you're looking to buy, sell, or simply explore, Jualan
            <span className="text-[#D6482b]">Online</span> invites you to join
            our growing community of auction enthusiasts. Discover new
            opportunities, uncover hidden gems, and experience the thrill of
            winning your next great find.
          </p>
        </div>
        <div>
          <p className="text-[#d6482b] text-xl font-bold mb-3">
            Thank you for choosing JualanOnline. We look forward to being a part
