      ...
      >
        <div className="bg-white h-fit transition-all duration-300 w-full">
          <div className="w-full px-5 py-4 sm:max-w-[640px] sm:m-auto">
            ...
            <form className="flex flex-col gap-2 my-4 text-xs">
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  className="text-xs px-1 py-2 bg-transparent border-[1px] border-stone-600 rounded-md focus:outline-none  text-stone-600"
                />
              </div>
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  className="text-xs px-1 py-2 bg-transparent border-[1px] border-stone-600 rounded-md focus:outline-none"
                />
              </div>
              ...
              <div>
                <Link
                  ...
                  className="bg-[#D6482B] flex justify-center w-full py-2 rounded-md text-white font-semibold text-xs transition-all duration-300 hover:bg-[#b8381e]"
                  target="_blank"
                >
                  Payment Proof (SS)
                </Link>
              ...
              <div>
                <button
                  type="button"
                  className="bg-blue-500 flex justify-center w-full py-2 rounded-md text-white font-semibold text-xs transition-all duration-300 hover:bg-blue-700"
              ...
              <div>
                <button
                  type="button"
                  className="bg-yellow-500 flex justify-center w-full py-2 rounded-md text-white font-semibold text-xs transition-all duration-300 hover:bg-yellow-700"
